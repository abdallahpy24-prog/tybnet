        ...
        <div className="mx-auto max-w-4xl">
            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-start">
              ...
              <div>
                ...
                <p className="mt-4 text-sm leading-7 text-slate-600 md:text-base">
                  توضّح هذه السياسة كيفية تعامل طب نت / TybNet مع البيانات المستخدمة في الموقع والتطبيق، خصوصاً عند البحث عن الخدمات الصحية والتجميلية أو إرسال طلب موعد أو التواصل مع فريق طب نت.
                </p>
              </div>
            </div>
          </div>
          ...
          <Card className="mt-8 space-y-8 leading-8 text-slate-700">
            <div>
              ...
              <p className="mt-2">
                طب نت دليل عراقي يساعد المستخدمين على اكتشاف مقدمي الخدمات الصحية والتجميلية، بما في ذلك الأطباء وأطباء الأسنان وأطباء التجميل ومراكز التجميل والصيدليات والمختبرات، والاطلاع على معلوماتهم أو التواصل معهم أو إرسال طلب موعد عند توفر الخدمة.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-2">
                قد نستخدم بيانات تقنية محدودة، مثل عنوان بروتوكول الإنترنت ونوع الجهاز أو المتصفح والصفحات المستخدمة، لأغراض الحماية ومنع إساءة الاستخدام وتحسين الأداء. وقد تُعالج بعض هذه البيانات أو تُخزّن بصيغة مجزأة.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-2">
                ...
                المنشورة، تحسين تجربة استخدام المنصة، وإدارة خدمات طب نت.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-2">
                ...
                تقارير طبية من خلال النماذج العامة في الموقع أو التطبيق.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-2">
                ...
                استخدام الموقع او التطبيق بعد التحديث قبولاً بالنسخة الجديدة.
              </p>
            </div>
