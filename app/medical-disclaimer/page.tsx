        ...
        <div className="mx-auto max-w-4xl">
            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-start">
              ...
              <div>
                ...
                <p className="mt-4 text-sm leading-7 text-slate-600 md:text-base">
                  توضّح هذه الصفحة حدود دور طب نت / TybNet فيما يتعلق بالمعلومات والخدمات الصحية والتجميلية المعروضة في الموقع والتطبيق، وطبيعة العلاقة بين المستخدم ومقدم الخدمة.
                </p>
              </div>
            </div>
          </div>
          ...
          <Card className="mt-8 space-y-8 leading-8 text-slate-700">
            ...
            <div>
              ...
              <p className="mt-2">
                المعلومات التي تظهر في الموقع أو التطبيق، مثل أسماء مقدمي الخدمة،
                الاختصاصات، العناوين، أوقات الدوام، الصور، وسائل التواصل،
                والعروض، هي معلومات تعريفية وتنظيمية لمساعدة الزائر على البحث
                والتواصل.
              </p>
              <p className="mt-2">
                لا يجب اعتبار أي معلومة في الموقع أو التطبيق نصيحة طبية أو توصية
            ...
            <div>
              ...
              <p className="mt-2">
                أي قرار طبي أو علاجي أو تجميلي يجب أن يتم بعد مراجعة طبيب أو مختص مؤهل.
            ...
            <div>
              ...
              <p className="mt-2">
                ...
                قبل طلب الموعد أو الزيارة أو الاعتماد على أي معلومة منشورة.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-2">
                إرسال طلب موعد من خلال موقع أو تطبيق طب نت لا يعني تأكيد الموعد نهائياً.
            ...
            <div>
              ...
              <p className="mt-2">
                ...
                تقارير طبية من خلال النماذج العامة في الموقع أو التطبيق. إذا احتجت إلى
            ...
            <div>
              ...
              <p className="mt-2">
                ...
                البحث والتعريف والتواصل، وأن أي خدمة صحية أو تجميلية أو قرار علاجي يكون
