        ...
        <div className="mx-auto max-w-4xl">
          ...
          <Card className="mt-8 space-y-8 leading-8 text-slate-700">
            <div>
              ...
              <p className="mt-2">
                طب نت دليل عراقي يساعد المستخدمين على اكتشاف مقدمي الخدمات الصحية والتجميلية، بما في ذلك الأطباء وأطباء الأسنان وأطباء التجميل ومراكز التجميل والصيدليات والمختبرات، والاطلاع على معلوماتهم والتواصل معهم أو إرسال طلب موعد عند توفر الخدمة.
              </p>
            </div>
